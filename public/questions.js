export const questions = [
  ...
  },
  {
    ...
    answers: [
...

      {
        ...
        nextQuestion: {
          question:
            'Jste poskytovatel služby státního cloud computingu podle zákona o informačních systémech veřejné správy',
          id: 'cloudAdd',
          type: 'buttons',
          answers: [{ text: 'Ano' }, { text: 'Ne' }],
        },
      },
      {
        ...
        nextQuestion: {
          question:
            'Jste poskytovatel služby datového centra (s výjimkou poskytovatele, který tuto službu poskytuje jako součást služby cloud computingu)',
          type: 'buttons',
          id: 'dataCenterAdd',
          answers: [{ text: 'Ano' }, { text: 'Ne' }],
        },
      },
      {
        ...
        nextQuestion: {
          question:
            'Jste poskytovatel služby internetového vyhledávače ve smyslu přímo použitelného právního předpisu Evropské unie',
          id: 'netSearchAdd',
          type: 'buttons',
          answers: [{ text: 'Ano' }, { text: 'Ne' }],
        },
      },
      {
        ...
        nextQuestion: {
          question:
            'Jste poskytovatel služby on-line tržiště podle zákona upravujícího ochranu spotřebitele',
          id: 'onlineMarketAdd',
          type: 'buttons',
          answers: [{ text: 'Ano' }, { text: 'Ne' }],
        },
      ...
      },
      {
        ...
        nextQuestion: {
          question:
            'Jste poskytovatel služeb systému překladu doménových jmen a poskytujete autoritativní služby pro překlad jmen domén pro použití třetí stranou pro více než 10 000 domén druhého řádu? ',
          id: 'domainAdd1',
          type: 'buttons',
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Aktivně poskytujete veřejně dostupné rekurzivní služby pro překlad jmen domén koncovým uživatelům internetu?',
                id: 'domainAdd2',
                type: 'buttons',
                answers: [{ text: 'Ano' }, { text: 'Ne' }],
              },
      ...
      },
      {
        ...
        nextQuestion: {
          question:
            'Jste kvalifikovaným poskytovatelem služby vytvářející důvěru',
          id: 'trustServiceAdd1',
          type: 'buttons',
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jste poskytovatel služby vytvářející důvěru podle přímo použitelného předpisu Evropské unie',
                id: 'trustServiceAdd2',
                type: 'buttons',
                answers: [{ text: 'Ano' }, { text: 'Ne' }],
              },
      ...
      },
      {
        ...
        nextQuestion: {
          question:
            'Jste poskytovatelem nejméně 100 000 aktivních pevných internetových přípojek na území České republiky',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jste poskytovatelem veřejně dostupné služby elektronických komunikací skrze nejméně 350 000 aktivních mobilních SIM karet na území České republiky',
      ...
      },
      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel národního CERT podle zákona o kybernetické bezpečnosti',
          type: 'buttons',
          id: 'nationalCertAdd',
          answers: [{ text: 'Ano' }, { text: 'Ne' }],
        },
      },
      {
        ...
        nextQuestion: {
          question:
            'Jste subjekt spravující a provozující registr domény nejvyšší úrovně',
      ...
      },
      {
        ...
        nextQuestion: {
          question:
            'Jste kvalifikovaný správce systému elektronické idenfikace podle zákona o elektronické identifikaci',
  ...
  },
  {
    ...
    answers: [
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatelem drážní dopravy na regionální dráze podle zákona o dráhách přičemž provádíte přepravu osob, věcí či zvířat nebo poskytujete trakci',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatelem drážní dopravy na veřejné přístupné vlečce podle zákona o dráhách přičemž provádíte přepravu osob, věcí či zvířat nebo poskytujete trakci',
          id: 'publicSidingAdd',
          type: 'buttons',
          answers: [{ text: 'Ano' }, { text: 'Ne' }],
        },
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel veřejně přístupné vlečkypodle zákona o dráhách',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste subjekt poskytující službu stavění vlakových cest na celostátní úrovni',
          id: 'railwayBuildAdd',
          type: 'buttons',
          answers: [{ text: 'Ano' }, { text: 'Ne' }],
        },
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na obchod s elektřinou podle energetického zákona',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jaký je průměrný počet vašich odběrných a předávacích míst za poslední dostupný kalendářní rok',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na distribuci elektřiny podle energetického zákona',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jaká je celková přenosová kapacita vaší ditribuční soustavy',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na přenos elektřiny podle energetického zákona',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel veřejně přístupné dobíjecí stanice podle zákona o pohonných hmotách, který je odpovědný za správu a provoz dobíjecí stanice, která poskytuje službu dobíjení koncovým uživatelům, a to i jménem a na účet poskytovatele mobility',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na činnost Elektroenergetického datového centra podle energetického zákona',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na činnosti operátora trhu podle energetického zákona',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel odezvy strany poptávky podle příslušného předpisu Evropské unie',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na ukládání elektřiny podle energetického zákona',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na výrobu elektřiny podle energetického zákona',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jaký je celkový instalovaný elektrický výkon výrobny, kterou disponujete',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na obchod s plynem podle energetického zákona',
          id: 'gasTradeAdd',
          type: 'buttons',
          answers: [{ text: 'Ano' }, { text: 'Ne' }],
        },
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na distribuci plynu podle energetického zákona',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na přepravu plynu podle energetického zákona',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na uskladňování plynu podle energetického zákona',
          id: 'storingGasAdd1',
          type: 'buttons',
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Provozujete podzemní zásobník plynu s projektovanou instalovanou kapacitou nejméně 200 mil. m³',
                id: 'storingGasAdd2',
                type: 'buttons',
                answers: [{ text: 'Ano' }, { text: 'Ne' }],
              },
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na výrobu plynu podle energetického zákona',
          id: 'gasProductionAdd',
          type: 'buttons',
          answers: [{ text: 'Ano' }, { text: 'Ne' }],
        },
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel čerpací stanice podle zákona o pohonných hmotách a provozujete alespoň 100 čerpacích stanic na území České republiky? ',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel skladovacího zařízení pro skladování ropy',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Disponujete zásobníkem nebo komplexem zásobníků s celkovou kapacitou nejméně 40 000 m³',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste ústřední správce zásob podle zákona o nouzových zásobách ropy',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na rozvod tepelné energie podle energetického zákona',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Disponujete soustavou zásobování tepelnou energií s celkovou přenosovou kapacitou nejméně 160 MW',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste držitel licence na výrobu tepelné energie podle energetického zákona',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Disponujete zdrojem tepelné energie s celkovým instalovaným tepelným výkonem nejméně 200 MW',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel obchodního systému podle zákona o podnikání na kapitálovém trhu',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste instituce elektronických peněz podle zákona o platebním styku',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Přesahuje váš roční průměrný objem vydaných elektronických peněz za dobu předchozích tří kalendářních let částku odpovídající 20 000 000 000 EUR',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Přesahuje váš roční průměrný objem provedených platebních transakcí za dobu předchozích tří kalendářních let částku odpovídající 40 000 000 000 EUR',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste ústřední protistrana podle přímo použitelného předpisu Evropské unie',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste úvěrová instituce podle přímo použitelného předpisu Evropské unie',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste distributor nebezpečných látek v množství stejném nebo větším, než je množství uvedené v příloze č. 1 k zákonu o prevenci závažných havárií v sloupci 3 tabulky I nebo II',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jste distributor nebezpečných látek v množství stejném nebo větším, než je množství uvedené v příloze č. 1 k zákonu o prevenci závažných havárií v sloupci 2 tabulky I nebo II',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel objektu zařazeného do skupiny B podle zákona o prevenci závažných havárií',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jste provozovatel objektu zařazeného do skupiny A podle zákona o prevenci závažných havárií',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce nebezpečných látek v množství stejném nebo větším, než je množství uvedené v příloze č. 1 k zákonu o prevenci závažných havárií v sloupci 3 tabulky I nebo II',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jste výrobce nebezpečných látek v množství stejném nebo větším, než je množství uvedené v příloze č. 1 k zákonu o prevenci závažných havárií v sloupci 2 tabulky I nebo II',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce předmětů z nebezpečných látek v množství stejném nebo větším, než je množství uvedené v příloze č. 1 k zákonu o prevenci závažných havárií v sloupci 3 tabulky I nebo II',
          ...
          answers: [
            ...
            },
            {
              ...
              nextQuestion: {
                question:
                  'Jste výrobce předmětů z nebezpečných látek v množství stejném nebo větším, než je množství uvedené v příloze č. 1 k zákonu o prevenci závažných havárií v sloupci 2 tabulky I nebo II',
                id: 'manufactureArticlesFromSubstancesAdd2',
                type: 'buttons',
                answers: [{ text: 'Ano' }, { text: 'Ne' }],
              },
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste schválený agent podle přímo použitelného předpisu Evropské unie',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste poskytovatel letových navigačních služeb podle přímo použitelného předpisu Evropské unie, ale nejste provozovatelem služby řízení letového provozu v převážné části vzdušného prostoru České republiky',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jste určeným a osvědčeným poskytovatelem meteorologických služeb podle přímo použitelného předpisu Evropské unie s působností pro poskytování meteorologických informací pro potřeby letectví v celé České republice',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Přepravili jste za předchozí 3 kalendářní roky průměrně alespoň 500 000 cestujících ročně',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel mezinárodního letiště podle zákona o civilním letectví s dočasným či trvalým vyhrazeným bezpečnostním prostorem podle přímo použitelného předpisu Evropské unie',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Odbavili jste za předchozí 3 kalendářní roky průměrně alespoň 150 000 cestujících ročně',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel pomocných zařízení v rámci mezinárodního letiště podle zákona o civilním letectví s dočasným či trvalým vyhrazeným bezpečnostním prostorem podle přímo použitelného předpisu Evropské unie',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste schválený dodavatel palubních zásob podle přímo použitelného předpisu Evropské unie',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste známý odesílatel podle přímo použitelného předpisu Evropské unie',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste poskytovatel služby při odbavovacím procesu na letišti podle zákona o civilním letectví',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel služby řízení letového provozu v převážné části vzdušného prostoru České republiky podle přímo použitelného předpisu Evropské unie',
...

  {
    ...
    answers: [
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel zařízení určeného pro nakládání s odpady podle zákona o odpadech',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel poštovní služby podle zákona o poštovních službách',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jste poskytovatel kurýrní služby podle přímo použitelného předpisu Evropské unie a poskytujete alespoň jeden z kroků v poštovním řetězci',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste potravinářský podnik podle přímo použitelného předpisu Evropské unie, který se zabývá velkoobchodní distribucí potravin',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste potravinářský podnik podle přímo použitelného předpisu Evropské unie, který se zabývá průmyslovou výrobou potravin',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste potravinářský podnik podle přímo použitelného předpisu Evropské unie, který se zabývá průmyslovým zpracováním potravin',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste subjekt vykonávající správu pozemní komunikace podle zákona o pozemních komunikacích',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste poskytovatel služby inteligentního dopravního systému podle zákona o pozemních komunikacích',
...

  {
    ...
    answers: [
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Jste hostitelská nebo partnerská instituce velké výzkumné infrastruktury',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výzkumná organizace podle přímo použitelného předpisu Evropské unie, veřejná výzkumná instituce nebo vysoká škola',
                ...
                answers: [
                  {
                    ...
                    nextQuestion: {
                      question:
                        'Patří váš obor do aplikovaného výzkumu a vývoje podle Struktury oborů FORD',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel pozemní infrastruktury využívané pro podporu poskytování služeb využívajících kosmického prostoru a zároveň nezajišťujete tuto službu podpory jako podnikatel zajišťující službu nebo síť elektronických komunikací podle zákona o elektronických komunikacích',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste řídící orgán přístavu podle příslušného předpisu Evropské unie nebo subjekt provozující dílo nebo zařízení v rámci přístavů',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel služby lodní dopravě (VTS) podle příslušného předpisu Evropské unie',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste subjekt vykonávající činnost námořní vodní dopravy podle přímo použitelného předpisu Evropské unie',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel kanalizace podle zákona o vodovodech a kanalizacích',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Poskytovali jste v předchozích 3 kalendářních letech služby odvádění nebo čištění odpadních vod průměrně alespoň 50 000 obyvatel',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste provozovatel vodovodu podle zákona o vodovodech a kanalizacích',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Zásobovali jste v předchozích 3 kalendářních letech pitnou vodou průměrně alespoň 50 000 obyvatel',
...

  {
    ...
    answers: [
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce vojenského materiálu uvedeného v seznamu vojenského materiálu podle zákona o zahraničním obchodu s vojenským materiálem',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce elektrických zařízení ve smyslu oddílu 27 klasifikace CZ-NACE',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce motorových vozidel, přívěsů a návěsů ve smyslu oddílu 29 klasifikace CZ-NACE',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce ostatních dopravních prostředků a zařízení ve smyslu oddílu 30 klasifikace CZ-NACE',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce počítačů, elektronických a optických přístrojů a zařízení ve smyslu oddílu 26 klasifikace CZ-NACE',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste jinde nezařazený výrobce strojů a zařízení ve smyslu oddílu 28 klasifikace CZ-NACE',
    ...
    answers: [
      {
        ...
        nextQuestion: {
          question:
            'Jste organizační složka státu zřízená ústředním orgánem státní správy, jíž bylo uděleno oprávnění k poskytování zdravotní péče ve smyslu zákona o zdravotních službách',
          ...
          answers: [
            {
              ...
              nextQuestion: {
                question:
                  'Disponoval jste v předchozích 3 kalendářních letech průměrně alespoň 270 lůžky akutní péče',
                ...
                answers: [
                  {
                    ...
                    nextQuestion: {
                      question:
                        'Jste poskytovatel zdravotní péče podle zákona o zdravotních službách',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste poskytovatel zdravotnické záchranné služby podle zákona o zdravotnické záchranné službě',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste referenční laboratoř Evropské unie podle přímo použitelného předpisu Evropské unie zahrnutá do sítě referenčních laboratoří pro oblast veřejného zdraví',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce diagnostických zdravotnických prostředků in vitro podle přímo použitelného předpisu Evropské unie',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce léčivých přípravků pro humánní použití podle zákona o léčivech',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce zdravotnických prostředků podle přímo použitelného předpisu Evropské unie',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste výrobce zdravotnických prostředků uvedených na seznamu kriticky důležitých zdravotnických prostředků při mimořádné situaci v oblasti veřejného zdraví podle přímo použitelného předpisu Evropské unie',
...

      {
        ...
        nextQuestion: {
          question:
            'Jste zadavatel klinických hodnocení podle přímo použitelného předpisu Evropské unie',
  ...
  },
  {
    ...
    id: 'revenue',
    answers: [
      { text: 'Obrat nebo rozvaha menší jak 2 miliony EUR', value: 0 },
      { text: 'Obrat nebo rozvaha menší jak 10 milionů EUR', value: 1 },
      {
        text: 'Obrat menší jak 50 milionů EUR nebo rozvaha menší jak 43 miliónů EUR',
        value: 2,
      },
      {
        text: 'Obrat větší jak 50 milionů EUR nebo rozvaha větší jak 43 miliónů EUR',
        value: 3,
      },
    ],
  },
